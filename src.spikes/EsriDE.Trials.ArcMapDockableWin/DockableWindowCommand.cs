...
namespace ArcMapClassLibrary1
{
	...
	/// </summary>
	[Guid("6a0692fa-c836-419b-bc69-9d62862ba0a5")]
	[ClassInterface(ClassInterfaceType.None)]
	[ProgId("ArcMapClassLibrary1.CommandDockableWindowCommand")]
	public sealed class DockableWindowCommand : BaseCommand
	{
		private IApplication m_application;
		private IDockableWindow m_dockableWindow;

		private const string DockableWindowGuid = "{07ae4f8f-4fba-412a-8fc6-b160a6146346}";
		...
		public DockableWindowCommand()
		{
			...
			base.m_name = "DeveloperTemplate_DockableWindowCommand";   //unique id, non-localizable (e.g. "MyCategory_ArcMapCommand")
